...
def add_project(
    ...
    return create_project(
        payload=payload, owner_id=owner_id, user_name=current_user.username
    )
...
def update_project(
    ...
    return project_update(project_id, payload, current_user.username)
...
def delete_project(project_id: int, current_user: User = Depends(get_current_user)):
    ...
    return remove_project(project_id, current_user.username)
