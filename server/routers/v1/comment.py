...
async def delete_comment(payload: RemoveCommentPayload, current_user: User = Depends(get_current_user)):
    ...
    Returns:
        The result of removing the comment and the updated list of comments for the specified task.
    """
...
async def update_comment(payload: UpdateCommentPayload, current_user: User = Depends(get_current_user)):
    ...
    Returns:
        The result of updating the comment and the updated list of comments for the specified task.
    """
