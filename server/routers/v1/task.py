...
def show_tasks(project_id: int, current_user: User = Depends(get_current_user)):
    """
...
def show_current_user_task(current_user: User = Depends(get_current_user)):
    """
...
def delete_task(
    ...
    return remove_task(project_id, payload)


@router.patch("/update")
def update_task(
    project_id: int, payload: UpdateTaskPayload, current_user: User = Depends(get_current_user)
):
    """
    ...
    return task_update(project_id, payload)
